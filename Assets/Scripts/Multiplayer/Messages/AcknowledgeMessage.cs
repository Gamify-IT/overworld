...
/// <summary>
///     Message type for acknowledging a connection message.
///     Consists of the local player's current data. 
/// </summary>
public class AcknowledgeMessage : NetworkMessage
{
    protected override MessageType Type => MessageType.Acknowledge;
    ...
    public AcknowledgeMessage(string playerId, Vector2 startPosition, byte worldIndex, byte dungeonIndex, string head, string body) : base(playerId)
    {
    ...
    public static new AcknowledgeMessage Deserialize(ref byte[] data)
    {
